...
public class on_air_TVshow extends Fragment {
    ...
    public on_air_TVshow() {
        // Required empty public constructor
    }

    // TODO: Rename and change types and number of parameters
    public static on_air_TVshow newInstance(int param1) {
        on_air_TVshow fragment = new on_air_TVshow();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_on_air__tvshow, container, false);
        recyclerView = (RecyclerView) v.findViewById(R.id.on_air_TVshow);
    ...
    public void loadNextDataFromApi(int offset) {
        ...
        Call<TvFrontResponse> call = service.getOnAirTv(offset);
