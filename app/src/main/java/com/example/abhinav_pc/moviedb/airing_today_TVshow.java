...
public class airing_today_TVshow extends Fragment {
    ...
    public airing_today_TVshow() {
        // Required empty public constructor
    }


    // TODO: Rename and change types and number of parameters
    public static airing_today_TVshow newInstance(int param1) {
        airing_today_TVshow fragment = new airing_today_TVshow();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_airing_today__tvshow, container, false);
        recyclerView = (RecyclerView) v.findViewById(R.id.airing_today_TVshow);
    ...
    public void loadNextDataFromApi(int offset) {
        ...
        Call<TvFrontResponse> call = service.getAiringTodayTv(offset);
